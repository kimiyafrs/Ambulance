                          ...
                          return Card(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  ListTile(
                                    title: Text('Ambulance ID : ${ambulance.id.toString()}')
                                        .Style(),
                                    subtitle: Column(
                                      crossAxisAlignment:
                                      CrossAxisAlignment.start,
                                      children: [
                                        Text('Ambulance code : ${ambulance.code }'?? 'No code')
                                            .Style(),
                                        Text('Is visible : ${ambulance.isVisible.toString()}')
                                            .Style(),
                                      ],
                                    ),
                                  ),
              ...
              builder: (controller) {
                return GNav(
                  ...
                  tabs: [
                    ...
                    GButton(
                      icon: Icons.save,text: 'Saved visits',
                    ),
